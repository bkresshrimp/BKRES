...
void SendDataToServer()
{
	...
	if(hasDataChanged(dataSensor, previousData))
	{
		...
		sprintf(AT_BUFFER ,"AT+HTTPPARA=\"URL\",\"http://sanslab.ddns.net:5000/api/data/sendData1?gateway_API=QDEDw9snWnmS03W7wY&device_API=QDEDw9snWnmS03W7wYSG6vi7mo&QDEDw9snWnmS03W7wYSG6vi7moRt5JKdBE=%.2f&QDEDw9snWnmS03W7wYSG6vi7moZUniGrV7=%.2f&QDEDw9snWnmS03W7wYSG6vi7moMQEq8ztO=%.2f&QDEDw9snWnmS03W7wYSG6vi7moCtligoVx=%.2f\"\r\n",dataSensor.DO,dataSensor.EC, dataSensor.PH, dataSensor.temperature);
